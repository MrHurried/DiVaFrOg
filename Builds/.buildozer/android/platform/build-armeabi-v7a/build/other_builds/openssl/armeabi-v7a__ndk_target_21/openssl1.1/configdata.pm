...
our %config = (
  AR => "llvm-ar",
  ARFLAGS => [ "rs" ],
  CC => "/home/matisse/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/clang -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  ...
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=21 -I/home/matisse/.buildozer/android/platform/android-ndk-r19c/sysroot/usr/include/arm-linux-androideabi -I/home/matisse/Documents/Python/DiVaFrOgProject/Builds/.buildozer/android/platform/build-armeabi-v7a/build/python-installs/divafrog/include/python3.8" ],
  CPPINCLUDES => [  ],
  CXX => "/home/matisse/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  CXXFLAGS => [ "-target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "  -L/home/matisse/Documents/Python/DiVaFrOgProject/Builds/.buildozer/android/platform/build-armeabi-v7a/build/libs_collections/divafrog/armeabi-v7a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/home/matisse/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/clang -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  minor => "1.1",
